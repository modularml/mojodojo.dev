...
head:
  ...
  - [meta, { name: twitter:title , content: "Modverse Weekly Issue 31" }]
  - [meta, { name: twitter:description , content: "Check out all the latest open source contributions, community projects, blogs, and videos" }]
